"""
YOLOE开放词汇表模型 - 纯文本提示实时检测脚本

这个脚本使用丰富的文本描述集合来提高特定物体的识别率，特别是扑克牌和筷子等物品。
与使用视觉提示的版本不同，这个脚本完全依赖于文本描述能力。
...
def detect_and_display(model):
    ...
    while True:
        ...
        try:
            ...
            # 显示检测结果
            cv2.imshow("YOLOE 纯文本提示检测", annotated_frame)
            ...
            cv2.imshow("YOLOE 纯文本提示检测", frame)
